                ...
                <div class="form">
                    <form action="/ruangan/store" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="code_room"placeholder="Masukkan Code ..." required="required">
                        </div>
                        <div class="form-group">
...
<?php echo $__env->make('template.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kampus\resources\views/admin/academic_room/create.blade.php ENDPATH**/ ?>
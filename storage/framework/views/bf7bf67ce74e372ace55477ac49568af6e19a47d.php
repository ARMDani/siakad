            ...
            <div class="card-body">
              <div class="form">
                ...
                <table class="table table-bordered table-hover table-wrapper">
                  ...
                  <tr>
                      <td><?php echo e($no); ?></td>
                      <td><?php echo e($rooms->code_room); ?></td>
                      <td><?php echo e($rooms->name); ?></td>
                      <td>
                          <a href="/ruangan/edit/<?php echo e($rooms->id); ?>" class="btn btn-secondary"> Edit </a>
                          <a href="/ruangan/hapus/<?php echo e($rooms->id); ?>"class="btn btn-danger"> Hapus </a>
                      </td>
                  </tr>
                  <?php $no++ ?>

                      ...
                      <div class="navbar-search-block">
                        <form class="form-inline" action="/user/cari" method="GET">
                          <div class="input-group input-group-sm">
                            <input class="form-control" type="text" name="cari" placeholder="Cari Data User ..."  value="<?php echo e(old('cari')); ?>">
                ...
                <table class="table table-bordered table-hover table-wrapper">
                  ...
                  <tr class="text-center">
                    <td><?php echo e($no++); ?></td>
                      ...
                      <td>
                          <a href="/user/edit/<?php echo e($penggunas->id); ?>" class="btn btn-light"> <i class="fas fa-edit"></i> </a>
                          <a href="/user/hapus/<?php echo e($penggunas->id); ?>"class="btn btn-danger"> <i class="nav-icon fas fa-trash-alt"></i> </a>

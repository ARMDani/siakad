              ...
              <div class="form">
                      ...
                      <div class="navbar-search-block">
                        <form class="form-inline" action="/leacture/cari" method="GET">
                          <div class="input-group input-group-sm">
                            <input class="form-control" type="text" name="cari" placeholder="Cari Data Dosen ..."  value="<?php echo e(old('cari')); ?>">
                ...
                <table class="table table-bordered table-hover table-wrapper">
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="/leacture/edit/<?php echo e($leactures->id); ?>" class="btn btn-secondary"> <i class="fas fa-edit"></i> </a>
                      <a href="/leacture/hapus/<?php echo e($leactures->id); ?>"class="btn btn-danger"> <i class="nav-icon fas fa-trash-alt"></i> </a>
                    </td>
                  </tr>
                  <?php $no++ ?>
                  ...
                  <div class="row">
                    <div class="col">
                        ...
                        Data Per Halaman : <?php echo e($leacture->perPage()); ?>

                ...
                <table class="table table-bordered table-hover table-wrapper">
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                          <a href="/kelas/edit/{{ $kelas->id }}" class="btn btn-secondary"> <i class="fas fa-edit"></i> </a>
                          <a href="/kelas/hapus/{{ $kelas->id }}"class="btn btn-danger"> <i class="nav-icon fas fa-trash-alt"></i> </a>
                      </td>
                  </tr>
                  <?php $no++ ?>
                  @endforeach
